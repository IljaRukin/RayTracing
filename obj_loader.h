...
triangle_mesh import_obj(triangle_mesh model, char basepath[], char filename[])
{
    //std::cout << "Loading " << filename << std::endl;

    std::string warn;
    std::string err;
    bool ret = tinyobj::LoadObj(&model.attrib, &model.shapes, &model.materials, &warn, &err, filename,
